## Feature Few Shot Learning with TabNSA and Gemma-1.1-2b-it
...
def get_gemma_embedding(input_ids, attention_mask):
    outputs = llm_model(input_ids=input_ids, attention_mask=attention_mask, output_hidden_states=True)
    hidden = outputs.hidden_states[-1]
    embedding = (hidden * attention_mask.unsqueeze(-1)).sum(dim=1) / attention_mask.sum(dim=1).unsqueeze(-1)
...
F1P1 = prepare_prompt_data(f"/jet/home/eslamian/Data/{DATA}/ZSL-LLM/features1_part1.csv")
F1P2 = prepare_prompt_data(f"/jet/home/eslamian/Data/{DATA}/ZSL-LLM/features1_part2.csv")
F2P1 = prepare_prompt_data(f"/jet/home/eslamian/Data/{DATA}/ZSL-LLM/features2_part1.csv")
F2P2 = prepare_prompt_data(f"/jet/home/eslamian/Data/{DATA}/ZSL-LLM/features2_part2.csv")
